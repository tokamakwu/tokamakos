...
_setvbemode:
    ...
    ;mov bx, 0x4118 ;; Cosmos; bx是设置显示模式, D15=0 清空内容
    ;; D0-D8 = 模式號
    ;; D9-D10 保留(必須=0)
    ;; D11 = 0 使用當前缺省刷新率; =1 使用用戶指定的 CRTCInfoBlock 結構來定制刷新率;
    ;; D12-D13 = 為VBE/AF 保留(必須=0)
    ;; D14 = 0 使用窗口幀緩衝區模式; =1 使用綫性/平坦幀緩衝模式;
    ;; D15 = 0清除顯示内存; =1 不清楚顯示内存
    mov bx, 0xc118 ;; Tokamak
    int 0x10
