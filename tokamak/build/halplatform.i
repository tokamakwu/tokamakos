# 0 "../hal/x86/halplatform.c"
# 1 "/home/casper/myoscode/tokamakos/tokamak/build//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "../hal/x86/halplatform.c"
...
void init_machbstart()
{
    ...
    machbstart_t *smbsp = ((machbstart_t *)(0x100000));
...
adr_t phyadr_to_viradr(adr_t kphyadr)
{
    if (kphyadr >= 0x400000000)
    {
        system_error("phyadr_to_viradr err\n");
        return 0xf800000000000;
    }

    return kphyadr + 0xffff800000000000;
}

adr_t viradr_to_phyadr(adr_t kviradr)
{
    if (kviradr < 0xffff800000000000 || kviradr > (0xffff800000000000 + 0x400000000))
    {
        system_error("viradr_to_phyadr err\n");
        return 0xf800000000000;
    }
    return kviradr - 0xffff800000000000;
}
...
fhdsc_t *get_fileinfo(char_t *fname, machbstart_t *mbsp)
{
    mlosrddsc_t *mrddadrs = (mlosrddsc_t *)phyadr_to_viradr((adr_t)(mbsp->mb_imgpadr + (0x1000)));
    if (mrddadrs->mdc_endgic != 0xaaffaaffaaffaaff ||
        mrddadrs->mdc_rv != 0xffaaffaaffaaffaa ||
