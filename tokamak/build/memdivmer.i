...
static inline sint_t retn_divoder(uint_t pages)
{
...
memarea_t *onfrmsa_retn_marea(memmgrob_t *mmobjp, msadsc_t *freemsa, uint_t freepgs)
{
 ...
 if ((1) != freemsa->md_indxflgs.mf_olkty || 0 == freemsa->md_odlink)
 {
  return 0;
 }
...
msadsc_t *mm_divpages_opmsadsc(msadsc_t *msastat, uint_t mnr)
{
 ...
 if (((1) != msastat->md_indxflgs.mf_olkty &&
   (2) != msastat->md_indxflgs.mf_olkty) ||
  0 == msastat->md_odlink ||
  (0) != msastat->md_phyadrs.paf_alloc)
 {
  system_error("mm_divpages_opmsadsc err1\n");
 }

 msadsc_t *mend = (msadsc_t *)msastat->md_odlink;
 if ((2) == msastat->md_indxflgs.mf_olkty)
 {
  mend = msastat;
 }
 if (mend < msastat)
 ...
 if (msastat->md_indxflgs.mf_uindx > ((0xffffff) - 1) || mend->md_indxflgs.mf_uindx > ((0xffffff) - 1) ||
 ...
 if (mend == msastat)
 {
  ...
  msastat->md_phyadrs.paf_alloc = (1);
  msastat->md_indxflgs.mf_olkty = (1);
...
sint_t mm_merpages_opmsadsc(bafhlst_t *bafh, msadsc_t *freemsa, uint_t freepgs)
{
 if (0 == bafh || 0 == freemsa || 1 > freepgs)
 {
  return 0;
 }
 if ((1) != freemsa->md_indxflgs.mf_olkty ||
  0 == freemsa->md_odlink)
 {
 ...
 if (freemsa == fmend)
 {
  ...
  freemsa->md_phyadrs.paf_alloc = (0);
  freemsa->md_indxflgs.mf_olkty = (2);
 ...
 freemsa->md_phyadrs.paf_alloc = (0);
 fmend->md_phyadrs.paf_alloc = (0);
 freemsa->md_indxflgs.mf_olkty = (1);


 freemsa->md_odlink = fmend;
 fmend->md_indxflgs.mf_olkty = (2);
...
bool_t onmpgs_retn_bafhlst(memarea_t *malckp, uint_t pages, bafhlst_t **retrelbafh, bafhlst_t **retdivbafh)
{
 if (0 == malckp || 1 > pages || 0 == retrelbafh || 0 == retdivbafh)
 {
  return 0;
 }
 ...
 for (sint_t idx = dividx; idx < 52; idx++)
 {
...
bool_t onfpgs_retn_bafhlst(memarea_t *malckp, uint_t freepgs, bafhlst_t **retrelbf, bafhlst_t **retmerbf)
{
 if (0 == malckp || 1 > freepgs || 0 == retrelbf || 0 == retmerbf)
 {
  return 0;
 }
...
msadsc_t *mm_divipages_onbafhlst(bafhlst_t *bafhp)
{
 ...
 if (list_is_empty_careful(&bafhp->af_frelst) == 1)
 {
  return 0;
 }
 msadsc_t *tmp = ((msadsc_t *)((char *)(bafhp->af_frelst.next) - (unsigned long)(&((msadsc_t *)0)->md_list)));
 list_del(&tmp->md_list);
 tmp->md_indxflgs.mf_uindx++;
 tmp->md_phyadrs.paf_alloc = (1);
 bafhp->af_fobjnr--;
 bafhp->af_mobjnr--;
 bafhp->af_alcindx++;
 return tmp;
...
bool_t mm_retnmsaob_onbafhlst(bafhlst_t *bafhp, msadsc_t **retmstat, msadsc_t **retmend)
{
 if (0 == bafhp || 0 == retmstat || 0 == retmend)
 {
  return 0;
 }
...
msadsc_t *mm_maxdivpages_onmarea(memarea_t *malckp, uint_t *retrelpnr)
{
 ...
 msadsc_t *retmstat = 0, *retmend = 0;
 bool_t rets = mm_retnmsaob_onbafhlst(bafhp, &retmstat, &retmend);
 if (0 == rets || 0 == retmstat || 0 == retmend)
 {
  *retrelpnr = 0;
  return 0;
 }
...
uint_t chek_divlenmsa(msadsc_t *msastat, msadsc_t *msaend, uint_t mnr)
{
 ...
 if (1 == mnr)
 {
  ...
  if ((0) != msastat->md_phyadrs.paf_alloc)
  {
   return 0;
  }
  if (list_is_empty_careful(&msastat->md_list) == 0)
  {
   return 0;
  }
  return ok + 1;
 ...
 for (; ms < me; ms++)
 {
  ...
  if ((0) != ms->md_phyadrs.paf_alloc ||
   (0) != (ms + 1)->md_phyadrs.paf_alloc)
  {
   return 0;
  }
  if (list_is_empty_careful(&ms->md_list) == 0 || list_is_empty_careful(&((ms + 1)->md_list)) == 0)
  {
   return 0;
  }
  if ((1UL << 12) != (((ms + 1)->md_phyadrs.paf_padrs << 12) - (ms->md_phyadrs.paf_padrs << 12)))
  {
   return 0;
  }
  ok++;
...
msadsc_t *mm_reldpgsdivmsa_bafhl(memarea_t *malckp, uint_t pages, uint_t *retrelpnr, bafhlst_t *relbfl, bafhlst_t *divbfl)
{
 ...
 bool_t rets = 0;
 msadsc_t *retmstat = 0, *retmend = 0;
 if (0 == malckp || 1 > pages || 0 == retrelpnr || 0 == relbfl || 0 == divbfl)
 {
  return 0;
 }
 if (relbfl > divbfl)
 ...
 for (bafhlst_t *tmpbfl = divbfl - 1; tmpbfl >= relbfl; tmpbfl--)
 {
  ...
  if (mrdmb_add_msa_bafh(tmpbfl, &retmstat[tmpbfl->af_oderpnr], (msadsc_t *)retmstat->md_odlink) == 0)
  {
...
msadsc_t *mm_reldivpages_onmarea(memarea_t *malckp, uint_t pages, uint_t *retrelpnr)
{
 if (0 == malckp || 1 > pages || 0 == retrelpnr)
 {
  return 0;
 }
 if (scan_mapgsalloc_ok(malckp, pages) == 0)
 {
  *retrelpnr = 0;
  return 0;
 }
 bafhlst_t *retrelbhl = 0, *retdivbhl = 0;
...
msadsc_t *mm_prcdivpages_onmarea(memarea_t *malckp, uint_t pages, uint_t *retrelpnr)
{
 if (0 == malckp || 0 == retrelpnr || 1 != pages)
 {
  return 0;
 }
 if (3 != malckp->ma_type)
 ...
 bool_t rets = 0;
 msadsc_t *retmsa = 0, *retmstat = 0, *retmend = 0;
...
msadsc_t *mm_divpages_core(memarea_t *mareap, uint_t pages, uint_t *retrealpnr, uint_t flgs)
{
 ...
 if (2 != mareap->ma_type && 1 != mareap->ma_type)
 {
  *retrealpnr = 0;
  return 0;
 }
...
msadsc_t *mm_division_pages(memmgrob_t *mmobjp, uint_t pages, uint_t *retrealpnr, uint_t mrtype, uint_t flgs)
{
 if (0 == mmobjp || 0 == retrealpnr || 0 == mrtype)
 {
  return 0;
 }
...
memarea_t *retn_procmarea(memmgrob_t *mmobjp)
{
 ...
 for (uint_t mi = 0; mi < mmobjp->mo_mareanr; mi++)
 {
  if (3 == mmobjp->mo_mareastat[mi].ma_type)
  {
   return &mmobjp->mo_mareastat[mi];
  }
 }
...
msadsc_t *divpages_procmarea_core(memmgrob_t *mmobjp, uint_t pages, uint_t *retrealpnr)
{
 cpuflg_t cpuflg;
 uint_t retpnr = 0;
 msadsc_t *retmsa = 0, *retmsap = 0;
 if (0 == mmobjp || 1 != pages || 0 == retrealpnr)
 {
  return 0;
 }
 ...
 if (scan_mapgsalloc_ok(marp, pages) == 0)
 {
  retmsap = 0;
  retpnr = 0;
  goto ret_step;
...
msadsc_t *mm_divpages_procmarea(memmgrob_t *mmobjp, uint_t pages, uint_t *retrealpnr)
{
 ...
 retmsa = mm_division_pages(mmobjp, pages, &retpnr, 2, 0);
 if (0 == retmsa)
 {
  *retrealpnr = 0;
  return 0;
...
bool_t scan_freemsa_isok(msadsc_t *freemsa, uint_t freepgs)
{
 if (0 == freemsa || 1 > freepgs)
 {
  return 0;
 }
 if ((1) != freemsa->md_indxflgs.mf_olkty ||
  0 == freemsa->md_odlink || 1 > freemsa->md_indxflgs.mf_uindx)
 {
  return 0;
 }
 msadsc_t *end = (msadsc_t *)freemsa->md_odlink;

 if ((1) != freemsa->md_phyadrs.paf_alloc ||
  (1) != end->md_phyadrs.paf_alloc ||
...
sint_t mm_cmsa1blk_isok(bafhlst_t *bafh, msadsc_t *_1ms, msadsc_t *_1me)
{
 ...
 if (_1ms == _1me)
 {
  if ((2) != _1me->md_indxflgs.mf_olkty)
  {
   return 0;
  }
  ...
  if ((0) != _1me->md_phyadrs.paf_alloc)
  {
   return 0;
  }
 ...
 if ((1) != _1ms->md_indxflgs.mf_olkty)
 {
  return 0;
 }
 ...
 if ((0) != _1ms->md_phyadrs.paf_alloc)
 {
  return 0;
 }
...
bool_t chek_cl2molkflg(bafhlst_t *bafh, msadsc_t *_1ms, msadsc_t *_1me, msadsc_t *_2ms, msadsc_t *_2me)
{
 if (0 == bafh || 0 == _1ms || 0 == _1me || 0 == _2ms || 0 == _2me)
 {
  return 0;
 }
 if (_1ms == _2ms || _1me == _2me)
 ...
 {
  if ((1) != _1ms->md_indxflgs.mf_olkty || (msadsc_t *)_1ms->md_odlink != _2me)
  {
   return 0;
  }
  if ((2) != _2me->md_indxflgs.mf_olkty || (bafhlst_t *)_2me->md_odlink != bafh)
  {
   return 0;
  }
  return 1;
 ...
 if ((0) != _1me->md_indxflgs.mf_olkty || 0 != _1me->md_odlink)
 {
  return 0;
 }
 if ((0) != _2ms->md_indxflgs.mf_olkty || 0 != _2ms->md_odlink)
 {
  return 0;
 }
 if ((2) != _2me->md_indxflgs.mf_olkty || (bafhlst_t *)_2me->md_odlink != bafh)
...
bool_t mm_clear_2msaolflg(bafhlst_t *bafh, msadsc_t *_1ms, msadsc_t *_1me, msadsc_t *_2ms, msadsc_t *_2me)
{
 ...
 _1me->md_indxflgs.mf_olkty = (0);
 _1me->md_odlink = 0;
 _2ms->md_indxflgs.mf_olkty = (0);
 _2ms->md_odlink = 0;
 _1ms->md_indxflgs.mf_olkty = (1);
 _1ms->md_odlink = _2me;
 _2me->md_indxflgs.mf_olkty = (2);
 _2me->md_odlink = bafh;
 return 1;
}
...
sint_t mm_find_cmsa2blk(bafhlst_t *fbafh, msadsc_t **rfnms, msadsc_t **rfnme)
{
 ...
 list_h_t *tmplst = 0;
 msadsc_t *tmpmsa = 0, *blkms = 0, *blkme = 0;
 sint_t rets = 0;
 for (tmplst = (&fbafh->af_frelst)->next; tmplst != (&fbafh->af_frelst); tmplst = tmplst->next)
 {
  tmpmsa = ((msadsc_t *)((char *)(tmplst) - (unsigned long)(&((msadsc_t *)0)->md_list)));
...
step1:
 ...
 if (2 == rets)
 {
  if (mm_clear_2msaolflg(fbafh + 1, freemstat, freemend, blkms, blkme) == 1)
  {
   if (chek_cl2molkflg(fbafh + 1, freemstat, freemend, blkms, blkme) == 0)
   {
 ...
 if (4 == rets)
 {
  if (mm_clear_2msaolflg(fbafh + 1, blkms, blkme, freemstat, freemend) == 1)
  {
   if (chek_cl2molkflg(fbafh + 1, blkms, blkme, freemstat, freemend) == 0)
   {
...
bool_t mpobf_add_msadsc(bafhlst_t *bafhp, msadsc_t *freemstat, msadsc_t *freemend)
{
 if (0 == bafhp || 0 == freemstat || 0 == freemend)
 {
  return 0;
 }
 ...
 freemstat->md_indxflgs.mf_olkty = (1);


 freemstat->md_odlink = freemend;
 freemend->md_indxflgs.mf_olkty = (2);
...
bool_t mm_merpages_onbafhlst(msadsc_t *freemsa, uint_t freepgs, bafhlst_t *relbf, bafhlst_t *merbf)
{
 ...
 if (mpobf_add_msadsc(tmpbf, mnxs, mnxe) == 0)
 {
  return 0;
 }
 return 1;
...
bool_t mm_merpages_onmarea(memarea_t *malckp, msadsc_t *freemsa, uint_t freepgs)
{
 if (0 == malckp || 0 == freemsa || 1 > freepgs)
 {
  return 0;
 }
 ...
 if (3 == malckp->ma_type)
 {
  ...
  if (2 == pocs)
  {
   if (mpobf_add_msadsc(prcbf, freemsa, &freemsa[freepgs - 1]) == 0)
   {
 ...
 bafhlst_t *retrelbf = 0, *retmerbf = 0;
 bool_t rets = 0;
...
bool_t mm_merpages_core(memarea_t *marea, msadsc_t *freemsa, uint_t freepgs)
{
 if (0 == marea || 0 == freemsa || 1 > freepgs)
 {
  return 0;
 }
 if (scan_freemsa_isok(freemsa, freepgs) == 0)
 {
  return 0;
 }
 bool_t rets = 0;
...
bool_t mm_merge_pages(memmgrob_t *mmobjp, msadsc_t *freemsa, uint_t freepgs)
{
 if (0 == mmobjp || 0 == freemsa || 1 > freepgs)
 {
  return 0;
 }
...
void write_one_mchkstuc(msadsc_t *msa, uint_t pnr)
{
 ...
 u64_t phyadr = msa->md_phyadrs.paf_padrs << 12;
...
bool_t chek_one_mchks(mchkstuc_t *mchs)
{
 ...
 msadsc_t *mstat = mchs->mc_msa, *mend = 0;
 if ((1) != mstat->md_indxflgs.mf_olkty || 0 == mstat->md_odlink)
 {
  kprint("chek_one_mchks 1\n");
  return 0;
 }
 mend = (msadsc_t *)mstat->md_odlink;
 if (((uint_t)(mend - mstat) + 1) != (mchs->mc_sz >> 12))
 {
...
void cmp_mchkstuc(mchkstuc_t *smchs, mchkstuc_t *dmchs)
{
 if (chek_one_mchks(smchs) == 0)
 {
  system_error("chek_one_mchks smchs fail\n");
 }
 if (chek_one_mchks(dmchs) == 0)
 {
...
void free_one_mchkstuc(mchkstuc_t *mchs)
{
 ...
 uint_t relnr = (uint_t)(mchs->mc_sz >> 12);
 if (mm_merge_pages(&memmgrob, mchs->mc_msa, relnr) == 0)
 {
  kprint("mm_merge_pages adr:%x,pnr:%x\n", mchs->mc_msa->md_phyadrs.paf_padrs << 12, relnr);
...
void free_all_mchkstuc()
{
 list_h_t *tmlst = 0;
 mchkstuc_t *mchs = 0;
 for (tmlst = (&memmgrob.mo_list)->next; tmlst != (&memmgrob.mo_list); tmlst = (&memmgrob.mo_list)->next)
 {
  mchs = ((mchkstuc_t *)((char *)(tmlst) - (unsigned long)(&((mchkstuc_t *)0)->mc_list)));
...
void chek_all_one_mchkstuc(mchkstuc_t *mchs)
{
 mchkstuc_t *mchsp = 0;
 list_h_t *tmplst;
 for (tmplst = (&memmgrob.mo_list)->next; tmplst != (&memmgrob.mo_list); tmplst = tmplst->next)
 {
  mchsp = ((mchkstuc_t *)((char *)(tmplst) - (unsigned long)(&((mchkstuc_t *)0)->mc_list)));
  if (mchs != mchsp)
  {
...
void chek_all_mchkstuc()
{
 ...
 for (tmplst = (&memmgrob.mo_list)->next; tmplst != (&memmgrob.mo_list); tmplst = tmplst->next)
 {
  mchs = ((mchkstuc_t *)((char *)(tmplst) - (unsigned long)(&((mchkstuc_t *)0)->mc_list)));
  chek_all_one_mchkstuc(mchs);
  i++;
  kprint("检查完第%d个内存空间块:正确.....sz:%d:pgs:%d\n", i, mchs->mc_sz, mchs->mc_sz >> 12);
 }
 kprint("全部检查完毕:正确!!\n");
 return;
}
...
uint_t retn_test_sec()
{
 memarea_t *mrp = memmgrob.mo_mareastat, *mar = 0;
...
void test_maxone_marea(memarea_t *mr)
{
 ...
 for (; mr->ma_freepages > pages;)
 {
  ...
  {
   stsc = x86_rdtsc();
   retmsa = mm_division_pages(&memmgrob, pages, &retpnr, mr->ma_type, 0);
   etsc = x86_rdtsc();
  }
...
void test_onedivmer_all(memarea_t *ma)
{
...

 {
  ...
  {
   stsc = x86_rdtsc();
   retmsa = mm_division_pages(&memmgrob, pages, &retpnr, ma->ma_type, 0);
   etsc = x86_rdtsc();
   if (0 == retmsa)
   {
