...
void hal_run_intflthandle(uint_t ifdnr, void *sframe)
{
    ...
    for (lst = (&ifdscp->i_serlist)->next; lst != (&ifdscp->i_serlist); lst = lst->next)
    {

        isdscp = ((intserdsc_t *)((char *)(lst) - (unsigned long)(&((intserdsc_t *)0)->s_list)));
...
{
    intfltdsc_t *ifdscp = 0;
    cpuflg_t cpuflg;
    if (intnumb > 256 || krnlsframp == 0)
    {
