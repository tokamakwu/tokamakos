...
void asm_ret_from_user_mode();
 ...
 __attribute__((section(".data"))) descriptor_t x64_gdt[1][10];
 __attribute__((section(".data"))) gate_t x64_idt[256];
 __attribute__((section(".data"))) x64tss_t x64tss[1];
 __attribute__((section(".data"))) igdtr_t x64_igdt_reg[1];
 __attribute__((section(".data"))) iidtr_t x64_iidt_reg;
 __attribute__((section(".data"))) machbstart_t kmachbsp;
 __attribute__((section(".data"))) dftgraph_t kdftgh;
 __attribute__((section(".data"))) memmgrob_t memmgrob;
 __attribute__((section(".data"))) intfltdsc_t machintflt[256];
